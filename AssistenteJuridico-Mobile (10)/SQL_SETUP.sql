...
-- ASSISTENTE JURÃDICO â Setup do Banco Neon (PostgreSQL)
-- Execute este SQL no painel do Neon: neon.tech â SQL Editor
-- âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ

-- Tabela de histÃ³rico de processamentos
...
-- Tabela de configuraÃ§Ãµes sincronizadas (opcional)
