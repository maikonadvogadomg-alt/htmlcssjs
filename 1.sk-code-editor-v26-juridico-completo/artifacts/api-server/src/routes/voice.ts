...
router.post("/speak", async (req: Request, res: Response) => {
  try {
    ...
    // gpt-audio-mini: Ãºnico modelo de Ã¡udio disponÃ­vel no proxy Replit
    const completion = await (openai.chat.completions as any).create({
      ...
      messages: [
        {
          role: "system",
          content: "VocÃª Ã© a Jasmim, assistente de IA da SK Code Editor. Leia o texto a seguir em voz alta, de forma natural e expressiva, em portuguÃªs brasileiro. NÃ£o adicione nada ao texto â leia exatamente como estÃ¡.",
        },
